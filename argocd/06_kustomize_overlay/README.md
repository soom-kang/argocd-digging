# 06_kustomize_overlay

- 매칭 Git 경로: `github/06_kustomize_overlay`
...
# 2. argocd/06_kustomize_overlay/argo_setup.yaml 설명
...
spec:
  source:
    path: github/06_kustomize_overlay/overlays/dev
```
...
# 3. github/06_kustomize_overlay 파일 설명
...
```bash
awk -v repo="$REPO_URL" '{gsub(/\$\{REPO_URL\}/,repo)}1' argocd/06_kustomize_overlay/argo_setup.yaml \
