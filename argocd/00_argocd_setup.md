...
2. `argocd/1_auto_sync_prune_self_heal/README.md`
3. `argocd/1_sync_waves_and_hooks/README.md`
4. `argocd/1_ignore_differences/README.md`
5. `argocd/1_helm_chart/README.md`
6. `argocd/1_kustomize_overlay/README.md`
